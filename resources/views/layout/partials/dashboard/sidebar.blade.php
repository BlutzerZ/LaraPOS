<div id="sidebar"
    class="sidebar fixed left-0 top-0 h-full w-64 bg-white shadow-2xl border-r z-40 transition-transform duration-300 flex flex-col justify-between">
    <div>
    ...
    <div class="p-4 border-t">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit"
                class="w-full flex items-center px-4 py-3 rounded-xl text-red-600 hover:bg-red-50 transition-all duration-200 font-medium">
